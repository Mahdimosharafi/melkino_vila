...
?><!doctype html>
<html <?php language_attributes(); ?>><head><meta charset="<?php bloginfo('charset'); ?>"><meta name="viewport" content="width=device-width, initial-scale=1"><meta name="theme-color" content="#58c66d"><?php wp_head(); ?></head>
<body <?php body_class(); ?>><?php wp_body_open(); ?>
<header class="property-site-nav"><div class="container property-nav-inner">
...
<a href="<?php echo esc_url($home_url); ?>">صفحه اصلی</a></nav>
<a class="property-nav-btn" href="<?php echo esc_url($submit_url); ?>">ثبت ملک <b>+</b></a>
</div></header>
